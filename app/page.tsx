      ...
      <div className="flex gap-32 h-full justify-center items-center">
        <div className="w-full h-full flex flex-col justify-center">
          ...
          <p className="text my-8">
            ...
            Nullam at arcu a est sollicitudin euismod. Nulla pulvinar eleifend
            sem. Aliquam ornare wisi eu metus. Etiam bibendum elit eget erat. Et
            harum quidem rerum facilis est et expedita distinctio. Morbi
            scelerisque luctus velit.
          </p>

          <button className="button flex label gap-2 items-center w-max">
            <Image src={icon.src} alt="Download" width={25} height={25} />
            Download CV
          </button>
        </div>
